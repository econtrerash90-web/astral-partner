    ...
    <div className="relative z-10 max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert prose-sm max-w-none space-y-6 text-foreground/80 font-body leading-relaxed">
        <section>
          ...
          <p><strong><a href="https://elfawa-ai-technologies.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Elfawa AI Technologies</a></strong> (en adelante "el Responsable"), con domicilio en México y sitio web <a href="https://elfawa-ai-technologies.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">elfawa-ai-technologies.com</a>, es responsable del tratamiento de sus datos personales a través de la plataforma <strong>Astrelle Guide</strong> (en adelante "la Aplicación"), accesible en <a href="https://astrelle-guide.app" className="text-primary hover:underline">astrelle-guide.app</a>.</p>
