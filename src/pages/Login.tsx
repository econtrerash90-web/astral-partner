    ...
    <div className="min-h-screen relative flex items-center justify-center">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground font-body text-sm">Accede a tu universo astral</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="flex items-center gap-2 text-foreground/80 font-body text-sm font-medium mb-2">
              <Lock className="w-3.5 h-3.5 text-primary" /> Contraseña
            </label>
            <input
              type="password"
              value={password}
        ...
        <div className="mt-6 text-center space-y-2">
          <Link to="/recuperar-password" className="text-muted-foreground hover:text-foreground text-sm font-body transition-colors block">
